...
try:
    ...
    import sys
    sys.path.extend(['C:\\Users\\TWSF\\Desktop\\ResNet'])
    from mypath import Path
...
def ResNet101(output_stride, BatchNorm, pretrained=True):
    ...
    if pretrained:
        chkpt = torch.load(Path.weights_root_dir('resnet101'))
...
if __name__ == "__main__":
    model = resnet101(output_stride=8, BatchNorm=nn.BatchNorm2d, pretrained=True) 
